          ...
          <section class="row g-3">
            <div class="col-12 col-xl-4">
              <div class="panel h-100 text-center profile-card">
                <div class="profile-cover"><img src="{{ url ('/assets/images/png/dasher-ui-bootstrap-5.jpg') }}" alt="adminHMD dashboard preview"></div>
                <img class="avatar-img avatar-xl profile-photo" src="{{ url ('/assets/images/avatar/avatar.jpg') }}" alt="Admin Hasan">
