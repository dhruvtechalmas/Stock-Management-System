                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select
                                    ...
                                    <option value="Kg"
                                        {{ old('unit', $material->unit) == 'Kg' ? 'selected' : '' }}>
                                        Kg
                                    </option>

                                    <option value="Liter"
                                        {{ old('unit', $material->unit) == 'Liter' ? 'selected' : '' }}>
                                        Liter
                                    </option>

                                    <option value="Piece"
                                        {{ old('unit', $material->unit) == 'Piece' ? 'selected' : '' }}>
                                        Piece
                                    </option>
                            ...
                            <div class="col-md-12">
                                ...
                                <select
                                    ...
                                    <option value="1"
                                        {{ old('status', $material->status) == 1 ? 'selected' : '' }}>
                                        Active
                                    </option>

                                    <option value="0"
                                        {{ old('status', $material->status) == 0 ? 'selected' : '' }}>
                                        Inactive
                                    </option>
